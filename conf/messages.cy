...
dividends.uk-dividends-amount.heading.individual = How much did you get in dividends from UK-based companies?
dividends.uk-dividends-amount.heading.agent = How much did your client get in dividends from UK-based companies?
dividends.uk-dividends-amount.change-amount.caption.individual = Tell us the value of the dividends you got, in pounds. You can find this information in your dividend voucher.
dividends.uk-dividends-amount.change-amount.caption.agent = Tell us the value of the dividends your client got, in pounds. You can find this information in your client’s dividend voucher.'
dividends.uk-dividends-amount.change-amount.prior.common.1 = You told us
...
dividends.uk-dividends-amount.change-amount.prior.individual = you got
dividends.uk-dividends-amount.change-amount.prior.agent = your client got
...
dividends.uk-dividends.sub-heading = Your dividend voucher will usually show your shares in the company and the dividends received.
dividends.uk-dividends.errors.noChoice = Select yes if dividends were received from the UK

dividends.other-dividends.title.individual = Did you receive any dividends from trusts or open ended investment companies?
dividends.other-dividends.title.agent = Did your client receive any dividends from trusts or open ended investment companies?
dividends.other-dividends.heading.individual = Did you receive any dividends from trusts or open ended investment companies?
dividends.other-dividends.heading.agent = Did your client receive any dividends from trusts or open ended investment companies?
dividends.other-dividends.errors.noChoice = Select yes if dividends were received trusts or investment companies

dividends.uk-dividends.title = What is the total amount of dividends earned from companies in the UK?
dividends.uk-dividends.heading = What is the total amount of dividends earned from companies in the UK?
...
dividends.other-dividends-amount.paragraph.2 = Do not include any amounts shown as ''equalisation'' on your dividend voucher.
dividends.other-dividends-amount.details.title = What are investment trusts and companies?
dividends.other-dividends-amount.details.paragraph.1 = Investment trusts are public companies that aim to make money through buying and selling shares or assets in other companies. They let you join a group of other investors with a fund manager to get the best possible return for your money.
dividends.other-dividends-amount.details.paragraph.2 = Unit trusts and open ended investment companies are the most popular investment funds. Open ended investment companies are like unit trusts except that they’re run like a company. They create and cancel shares rather than units when investors join or leave.
dividends.other-dividends-amount.details.paragraph.3 = Equalisation payments are what an investor receives after making an investment part way through a distribution period. They’re made up of the income generated before the investment and included in the price paid for each unit. They are not considered income as it is a return of part of the investor’s capital.

dividends.cya.title = Check your answers
dividends.cya.h1 = Check your answers
dividends.cya.questions.1 = Dividends from UK companies
dividends.cya.questions.2 = Amount of dividends from UK companies
dividends.cya.questions.3 = Dividends from unit trusts or investment companies
dividends.cya.questions.4 = Amount of dividends from unit trusts or investment companies
...
dividends.cya.changeOtherDividends.individual = if you got dividends from trusts or investment companies based in the UK.
dividends.cya.changeOtherDividends.agent = if your client got dividends from trusts or investment companies based in the UK.
dividends.cya.changeOtherDividendsAmount.individual = how much you got in dividends from trusts or investment companies based in the UK.
dividends.cya.changeOtherDividendsAmount.agent = how much your client got in dividends from trusts or investment companies based in the UK.
...
interest.untaxed-uk-interest-accounts.h1.single = UK untaxed interest account
interest.untaxed-uk-interest-accounts.h1.multiple = UK untaxed interest accounts
...
interest.taxed-uk-interest.paragraph.1 = For example, interest from:
...
interest.taxed-uk-interest-accounts.h1.single = UK taxed interest account
interest.taxed-uk-interest-accounts.h1.multiple = UK taxed interest accounts
...
charity.amount-overseas-gift-aid.heading.individual = How much did you donate to overseas charities by using Gift Aid?
charity.amount-overseas-gift-aid.heading.agent = How much did your client donate to overseas charities by using Gift Aid?
